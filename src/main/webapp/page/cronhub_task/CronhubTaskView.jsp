	...
	<table class="grid">
		<thead>
			<tr>
				...
				<th><span>创建人</span></th>
				<%-- <th><span><select name="filter_state_run_mode" trigger="change" stat="equal" trigger_target="this">
								<option value="-1">模式</option>
								<option  value="1">主动</option>
								<option value="0">被动</option>
						</select><img src="<%=basePath%>res/icons/16x16/magnifier.png"/></span></th> --%>
				<th><span><select name="filter_state_is_process_node" trigger="change" stat="equal" trigger_target="this">
								<option value="-1">任务类型</option>
								<option  value="0">单任务</option>
								<option value="1">流程任务</option>
						</select><img src="<%=basePath%>res/icons/16x16/magnifier.png"/></span></th>
				<th><span>通信</span></th>
		...
		<tbody>
			...
			<tr id="<s:property value='#taskbean.id' />">
				...
				<td align="center"><span><s:property value="#taskbean.user_id" /></span></td>
