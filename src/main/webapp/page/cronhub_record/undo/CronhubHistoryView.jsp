...
$(function() {
	...
	initPagerBtnAndChangeFilter("<%=basePath%>record-undo/first_page_view.action","<%=basePath%>record-undo/prev_page_view.action","<%=basePath%>record-undo/next_page_view.action","<%=basePath%>record-undo/last_page_view.action");
	hideLongText();
